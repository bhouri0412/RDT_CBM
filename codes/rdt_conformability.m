function [res_theer,res_hmin,res_zr,res_yr,res_alr,res_z0,res_uoc,res_uic,res_loc,res_lic,...
...
%this code performs the computation related to the conformability study for one specific ring gap position
...
inputsl3.features.IsBDist=IsBDist;
inputsl3.features.IsPTilt=IsPTilt;
inputsl3.features.IsGDef=IsGDef;
inputsl3.features.IsFreeshape=IsFreeshape;
...
prompt='Ring gap position in bore fixed reference from thrust to thrust side (deg): ';
...
mu_oil=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\mu_oil.txt'); %user has to provide this
angle_mu_oil=mu_oil(:,1);
mu_oil=mu_oil(:,2);
...
Pu=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\Pu.txt'); %user has to provide this
angle_Pu=Pu(:,1);
Pu=Pu(:,2);
...
Pi=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\Pi.txt'); %user has to provide this
angle_Pi=Pi(:,1);
Pi=Pi(:,2);
...
Pd=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\Pd.txt'); %user has to provide this
angle_Pd=Pd(:,1);
Pd=Pd(:,2);
...
hrls=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\hrls.txt'); %user has to provide this
angle_hrls=hrls(:,1);
hrls=hrls(:,2);
...
%flank in microns
hot=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\hot.txt'); %user has to provide this
angle_hot=hot(:,1);
hot=hot(:,2);
...
%flank in microns
hob=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\hob.txt'); %user has to provide this
angle_hob=hob(:,1);
hob=hob(:,2);
...
%Celsius
templ=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\templ.txt'); %user has to provide this
angle_templ=templ(:,1);
templ=templ(:,2);
...
isfuel=dlmread('C:\Users\YangLiu\Desktop\Aziz Perso\papers mit\RA\RDT\Texts\isfuel.txt'); %user has to provide this
angle_fuel=isfuel(:,1);
isfuel=isfuel(:,2);
...
cf2=input(prompt); 
prompt='Ring width to use for the determinstic hydrodynamic correlation (mm): ';
rw=input(prompt)*1e-3; 

%=====================prepare local input matrix======================%
inputsl3.pistonSM.beta_p=beta_p;
inputsl3.pistonSM.off=off;

inputsl3.bore.Db=Db;
inputsl3.bore.Ab=Ab;
inputsl3.bore.Phib=Phib;
inputsl3.bore.templ=templ;

inputsl3.oil.zk=zk;
inputsl3.oil.temp1=temp1;
inputsl3.oil.temp2=temp2;
inputsl3.oil.rho_oil=rho_oil;
inputsl3.oil.hlratio=hlratio;
inputsl3.oil.bta1=bta1;
inputsl3.oil.bta2=bta2;
inputsl3.oil.zm0=zm0;
inputsl3.oil.mu_oil=mu_oil;

inputsl3.ring.auo=auo;
inputsl3.ring.aui=aui;
inputsl3.ring.alo=alo;
inputsl3.ring.ali=ali;
inputsl3.ring.huo=huo;
inputsl3.ring.hui=hui;
inputsl3.ring.hlo=hlo;
inputsl3.ring.hli=hli;
inputsl3.ring.thrt=thrt;           
inputsl3.ring.thrb=thrb;           
inputsl3.ring.rb1=rb1;
inputsl3.ring.rb2=rb2;
inputsl3.ring.rbn=rbn;
inputsl3.ring.a10=a10;
inputsl3.ring.a11=a11;
inputsl3.ring.a12=a12;
inputsl3.ring.a20=a20;
inputsl3.ring.a21=a21;
inputsl3.ring.a22=a22;
inputsl3.ring.arm=arm;
inputsl3.ring.gap=gap;
inputsl3.ring.rhor=rhor;
inputsl3.ring.Er=Er;
inputsl3.ring.alT=alT;
inputsl3.ring.nur=nur;
inputsl3.ring.Gr=Gr;
inputsl3.ring.Ac=Ac;
inputsl3.ring.Izz=Izz;
inputsl3.ring.Iyy=Iyy;
inputsl3.ring.Izr=Izr;
inputsl3.ring.Ip=Ip;
inputsl3.ring.Jt=Jt;
inputsl3.ring.alp=alp;
inputsl3.ring.Rr=Rr;
inputsl3.ring.Le=Le;
inputsl3.ring.mr=mr;
inputsl3.ring.Tg=Tg;
inputsl3.ring.rTemp=rTemp;
inputsl3.ring.dTemp=dTemp;
inputsl3.ring.idr2g=idr2g;
inputsl3.ring.idg2r=idg2r;

inputsl3.piston.Drldu=Drldu;
inputsl3.piston.Drg=Drg;
inputsl3.piston.Drldl=Drldl;
inputsl3.piston.hgi=hgi;
inputsl3.piston.thgt=thgt;
inputsl3.piston.thgb=thgb;
inputsl3.piston.sigmag1t=sigmagt;
inputsl3.piston.sigmag1b=sigmagb;
inputsl3.piston.nug=nug;
inputsl3.piston.Eg=Eg;
inputsl3.piston.exp_land_u=exp_land_u;
inputsl3.piston.exp_land_l=exp_land_l;
inputsl3.piston.gr_exp=gr_exp;

inputsl3.liner.El=El;
inputsl3.liner.nul=nul;
inputsl3.liner.sigmap=sigmap;
inputsl3.liner.PR=PR;

inputsl3.FEM.Nbe=Nbe;
inputsl3.FEM.Nbnod=Nbnod;
inputsl3.FEM.Telt=Telt;
inputsl3.FEM.Npe=Npe;
inputsl3.FEM.Nr=Nr;
inputsl3.FEM.Le=Le;
inputsl3.FEM.Tnod=Tnod;
inputsl3.FEM.Vnod=Vnod;
inputsl3.FEM.uref=uref;
inputsl3.FEM.href=href;
inputsl3.FEM.Nge=Nge;
inputsl3.FEM.Ng=Ng;

inputsl3.contact.z=z;
inputsl3.contact.Pk_rl=Pk_rl;
inputsl3.contact.Pk_rg=Pk_rg;
inputsl3.contact.omega=omega;
inputsl3.contact.fc_dry=fc_dry;
inputsl3.contact.cfct=cfct;

inputsl3.groove.y1u=y1u;
inputsl3.groove.y2u=y2u;
inputsl3.groove.lfu=lfu;
inputsl3.groove.y1l=y1l;
inputsl3.groove.y2l=y2l;
inputsl3.groove.lfl=lfl;
inputsl3.groove.gcl=gcl;
inputsl3.groove.Agu=Agu;
inputsl3.groove.Phigu=Phigu;
inputsl3.groove.Agl=Agl;
inputsl3.groove.Phigl=Phigl;
inputsl3.groove.tilt_thu=tilt_thu;
inputsl3.groove.tilt_thl=tilt_thl;

inputsl3.engine.Vp=Vp;
inputsl3.engine.Ap=Ap;
inputsl3.ring.Fi=Fi;
inputsl3.engine.Pu=Pu;
inputsl3.engine.Pd=Pd;
inputsl3.engine.Pi=Pi;

inputsl3.liner.PR=PR;
inputsl3.liner.Ph=Ph;
inputsl3.liner.KOCR=KOCR;
inputsl3.liner.ap=ap;
inputsl3.liner.cp1=cp1;
inputsl3.liner.cp2=cp2;
inputsl3.liner.F0=F0;
inputsl3.liner.cf1=cf1;
inputsl3.liner.cf2=cf2;
inputsl3.liner.rw=rw;
inputsl3.liner.muUot=muUot;
inputsl3.liner.b=b;
inputsl3.liner.c=c;
inputsl3.liner.d=d;
inputsl3.liner.e=e;
inputsl3.lubrication.hrls=hrls;
inputsl3.lubrication.isfuel=isfuel;
inputsl3.lubrication.hot=hot;
inputsl3.lubrication.hob=hob;
inputsl3.lubrication.minoil=minoil;
inputsl3.lubrication.oilthreshold=oilthreshold;
inputsl3.lubrication.viscosityfactor=viscosityfactor;
...
inputsl3.FEM.Kg_nd=Kg_nd;

UgIC_nd=zeros(8*Nbnod,1);
[ybn]=bore_dist_static_vg(inputsl3);
...
[zgnu,zgnl]=groove_dist_static_vg(inputsl3);
...
judge1=1;
judge2=1;
[NLS_0,yr,zr,alr,hmin,fl,z0,~,~,~]=Static_Error_vg(Ug_nd,F1,inputsl3);
NLS_k=NLS_0;
j=0;

while j<=ItMax&&(judge1||judge2)
    j=j+1;
    [Ja_stac]=Jacobian_Estac_vg(Ug_nd,inputsl3);
    Nstep=-Ja_stac\NLS_k; 
    Ugo_nd=Ug_nd;
    Erro=norm(NLS_k);
    itGB=0; dErr=-1;
    ...
    if j<4
        while (dErr<0)&&(itGB<20)
            ...
            Ug_nd=Ugo_nd+Nstep; 
            [NLS_k,yr,zr,alr,hmin,fl,z0,~,~,~]=Static_Error_vg(Ug_nd,F1,inputsl3);
            Err=norm(NLS_k); 
            dErr=Erro-Err;
            itGB=itGB+1;
        end
 ...
 for j=1:Nbe
  ...
  display(['Ft(CBM) = ', num2str(sum(fl*Rr/Nr)),'N'])
 ...
 subplot(211)
 hold on
 plot(theer(1:Npe:end),(hmin(1:Npe:end))*1e6,'ro')
 plot(theer,hmin*1e6,'linewidth',1.5)
 ...
 subplot(212)
 hold on
 plot(theer(1:Npe:end),(yr(1:Npe:end))*1e6,'ro')
 plot(theer,yr*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ...
 subplot(311)
 hold on
 plot(theer(1:Npe:end),zr(1:Npe:end)*1e6,'ro')
 plot(theer,zr*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ...
 subplot(312)
 hold on
 plot(theer(1:Npe:end),alr(1:Npe:end)/pi*180,'ro')
 plot(theer,alr/pi*180,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ...
 subplot(313)
 hold on
 plot(theer(1:Npe:end),z0(1:Npe:end)*1e6,'ro')
 plot(theer,z0*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ...
 subplot(221)
 hold on
 plot(theer(1:Npe:end),uoc(1:Npe:end)*1e6,'ro')
 plot(theer,uoc*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ylabel('Upper OD Clearance (\num)','FontSize',12)
 set(gca,'XTick',[0:90:360])
 xlim([0 360])
 hold off
 grid
 ...
 subplot(222)
 hold on
 plot(theer(1:Npe:end),uic(1:Npe:end)*1e6,'ro')
 plot(theer,uic*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ylabel('Upper ID Clearance (\num)','FontSize',12)
 set(gca,'XTick',[0:90:360])
 xlim([0 360])
 hold off
 grid
 ...
 subplot(223)
 hold on
 plot(theer(1:Npe:end),loc(1:Npe:end)*1e6,'ro')
 plot(theer,loc*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ...
 subplot(224)
 hold on
 plot(theer(1:Npe:end),lic(1:Npe:end)*1e6,'ro')
 plot(theer,lic*1e6,'linewidth',1.5)
 xlabel('Circumferential Direction (degree)','FontSize',12)
 ...
 temp=inputsl3.bore.templ;
 dt=1;
 sigmagt=inputsl3.piston.sigmag1t;
 sigmagb=inputsl3.piston.sigmag1b;
 Ph_OCR=inputsl3.liner.Ph;
 fc=inputsl3.contact.fc_dry;
 isfuela=inputsl3.lubrication.isfuel;
 temp_liner=temp;
...
for j=1:Nbe
    ...
    [~,~,fhl,ffl,mhl]=ring_liner_hydro_vg(arm,rb1,rb2,rbn,a10,a11,a12,a20,a21,a22,Db,yb,Rr,yre,alre,hrle,KOCR,Kpe,Kfe,Ph_OCR,ap,F0,b,c,d,e,rw,muUot,templ,isfuele,Vp,inputsl3.oil,sigmap,oilthreshold,viscosityfactor);
...
legend('Stress at Upper OD','Stress at Upper ID','Stress at Lower OD','Stress at Lower ID')
set(gca,'XTick',[0:90:360])
xlim([0 360])
hold off
grid
