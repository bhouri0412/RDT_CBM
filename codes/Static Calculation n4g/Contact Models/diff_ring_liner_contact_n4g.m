function [dfdy,dfdalr,dmdy,dmdalr]=diff_ring_liner_contact_n4g(arm,rb1,rb2,rbn,a10,a11,a12,a20,a21,a22,Db,yb,Rr,yr,alr,alp,PR,sigmap,zk,Pk,omega)
%alr=alr-alp;
Npe=length(yr);
...
if nnz(checktwopoints)
    ...
    Pcl=PR*Pk*(omega-h/sigmap).^zk.*(h/sigmap<=4);
