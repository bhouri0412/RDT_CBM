function [E_stac]=Static_Error_o(Ug_nd,F1,inputs)
...
[Fext_nd]=Ext_Forces_static_o(Ug_nd,inputs);

F1_nd=zeros(8*Nbnod,1);
F1_nd(1:8:end-7)=F1(1:8:end-7)*Rr^4*Telt^4/Le/Er/Izz/uref; % in no dimensions
